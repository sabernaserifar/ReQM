...
class Atoms(object):
    ...
    def __init__(self, symbols=None,
                 ...
                 magmoms=None, mol_ids = None, charges=None,
        ...
        if atoms is not None:
            ...
            if mol_ids is None and atoms.has('mol_id'):
                mol_ids = atoms.get_mol_ids()
        ...
        self.set_mol_ids(default(mol_ids, 1))
    ...
    def set_mol_ids(self, mol_ids=None):
        """Set the molecule IDs."""
        if mol_ids is None:
            self.set_array('mol_id', None)
        else:
            self.set_array('mol_id', mol_ids, int, ())

    def get_mol_ids(self):
        """Get array of molecule IDs."""
        if 'mol_id' in self.arrays:
            return self.arrays['mol_id'].copy()
        else:
            return np.zeros(len(self), int)
